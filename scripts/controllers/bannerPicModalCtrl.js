angular.module('newApp').controller('bannerPicModalCtrl', function ($timeout,Aws,Upload,ZoloCollection,$uibModalInstance, Profile, $rootScope, $scope, UserProfile, $auth, $location,profile) {
    ...
    $scope.upload = function (file,blobUrl) {
        ...
        $scope.profile.banner = 'https://scaledesk.s3.amazonaws.com/' + file.key;
        Upload.upload({
